 ...
 * )
 */
class PuestoSubfamilia extends Model
{
    use SoftDeletes;

    use HasFactory;

    public $table = 'puestos_subfamilias';
    ...
    {
        return $this->hasMany(\App\Models\PuestoNomenclatura::class, 'puesto_subfamilia_id');
    }
}
